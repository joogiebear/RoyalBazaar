...
LAYOUT = {
    'farming': ('&aFarming', 'minecraft:golden_hoe', (2, 3), [
        ('wheat_seeds', 'Wheat & Seeds', 'minecraft:wheat',
         ['wheat', 'wheat_seeds', 'enchanted_wheat', 'enchanted_seeds', 'enchanted_bread', 
          'enchanted_hay_bale']),
        ...
        ('pumpkin', 'Pumpkin', 'minecraft:pumpkin',
         ['pumpkin', 'enchanted_pumpkin', 'enchanted_pumpkin_pie']),
        ('melon', 'Melon', 'minecraft:melon',
         ['melon_slice', 'melon', 'enchanted_melon_slice', 'enchanted_melon', 
          'enchanted_glistering_melon_slice']),
        ('mushroom', 'Mushrooms', 'minecraft:red_mushroom',
         ['red_mushroom', 'brown_mushroom', 'enchanted_red_mushroom', 
          'enchanted_red_mushroom_block', 'enchanted_brown_mushroom', 
        ...
        ('cactus', 'Cactus', 'minecraft:cactus',
         ['cactus', 'enchanted_cactus', 'enchanted_cactus_green']),
        ...
        ('apple', 'Apple', 'minecraft:apple',
         ['apple', 'enchanted_apple', 'enchanted_golden_apple']),
        ('leather_beef', 'Leather & Beef', 'minecraft:leather',
         ['leather', 'beef', 'enchanted_leather', 'enchanted_raw_beef']),
        ('pork', 'Pork', 'minecraft:porkchop',
         ['porkchop', 'enchanted_raw_porkchop', 'enchanted_cooked_porkchop']),
        ('chicken', 'Chicken & Feather', 'minecraft:chicken',
         ['chicken', 'egg', 'feather', 'enchanted_raw_chicken', 'enchanted_egg', 
          'enchanted_feather', 'enchanted_cake']),
        ('mutton', 'Mutton & Wool', 'minecraft:mutton',
         ['mutton', 'white_wool', 'enchanted_raw_mutton', 'enchanted_cooked_mutton', 
          'enchanted_wool']),
        ('rabbit', 'Rabbit', 'minecraft:rabbit',
         ['rabbit', 'rabbit_foot', 'rabbit_hide', 'enchanted_raw_rabbit', 
          'enchanted_rabbit_foot', 'enchanted_rabbit_hide']),
        ('nether_wart', 'Nether Warts', 'minecraft:nether_wart',
         ['nether_wart', 'enchanted_nether_wart']),
    ]),
    ...
    'mining': ('&bMining', 'minecraft:stone_pickaxe', (2, 5), [
        ...
        ('gold', 'Gold', 'minecraft:gold_ingot',
         ['gold_ingot', 'enchanted_gold_nugget', 'enchanted_gold_ingot', 'enchanted_gold_block']),
        ('diamond', 'Diamond', 'minecraft:diamond',
         ['diamond', 'enchanted_diamond', 'enchanted_diamond_block']),
        ('lapis', 'Lapis', 'minecraft:lapis_lazuli',
         ['lapis_lazuli', 'enchanted_lapis_lazuli', 'enchanted_lapis_lazuli_ore', 
        ...
        ('redstone', 'Redstone', 'minecraft:redstone',
         ['redstone', 'enchanted_redstone_dust', 'enchanted_redstone_block']),
        ('quartz', 'Quartz', 'minecraft:quartz',
         ['quartz', 'enchanted_nether_quartz', 'enchanted_quartz_block', 
          'enchanted_chiseled_quartz_block']),
        ('obsidian', 'Obsidian', 'minecraft:obsidian', ['obsidian', 'enchanted_obsidian']),
        ('end_stone', 'End Stone', 'minecraft:end_stone', ['end_stone', 'enchanted_end_stone']),
        ('flint_gravel', 'Flint & Gravel', 'minecraft:flint',
         ['flint', 'gravel', 'enchanted_flint', 'enchanted_gravel']),
        ('sand', 'Sand', 'minecraft:sand', ['sand', 'red_sand', 'enchanted_sand', 'enchanted_red_sand']),
        ('ice', 'Ice', 'minecraft:ice', ['ice', 'packed_ice', 'enchanted_ice', 'enchanted_packed_ice']),
        ('snow', 'Snow', 'minecraft:snow_block', ['snow_block', 'enchanted_snow_block']),
        ...
        ('netherrack', 'Netherrack', 'minecraft:netherrack',
         ['netherrack', 'enchanted_netherrack', 'enchanted_nether_brick']),
        ('mycelium', 'Mycelium', 'minecraft:mycelium', ['mycelium', 'enchanted_mycelium']),
        ('stone_glass', 'Stone & Glass', 'minecraft:bricks',
         ['brick', 'bricks', 'glass', 'enchanted_brick', 'enchanted_bricks', 'enchanted_glass']),
    ]),

    'combat': ('&cCombat', 'minecraft:iron_sword', (2, 7), [
        ('rotten_flesh', 'Rotten Flesh', 'minecraft:rotten_flesh', ['rotten_flesh', 'enchanted_rotten_flesh']),
        ('bone', 'Bone', 'minecraft:bone', ['bone', 'enchanted_bone', 'enchanted_bone_meal']),
        ('arachnids', 'Arachnids', 'minecraft:string',
         ['string', 'spider_eye', 'enchanted_string', 'enchanted_spider_eye', 
          'enchanted_fermented_spider_eye']),
        ('gunpowder', 'Gunpowder', 'minecraft:gunpowder',
         ['gunpowder', 'enchanted_gunpowder', 'enchanted_firework_rocket', 
          'enchanted_firework_star']),
        ...
        ('slimes', 'Slimes', 'minecraft:slime_ball',
         ['slimeball', 'enchanted_slimeball', 'enchanted_slime_block']),
        ('magma_cream', 'Magma Cream', 'minecraft:magma_cream', ['magma_cream', 'enchanted_magma_cream']),
        ('blaze', 'Blaze Rod', 'minecraft:blaze_rod',
         ['blaze_rod', 'enchanted_blaze_powder', 'enchanted_blaze_rod']),
        ('ghast_tear', 'Ghast Tear', 'minecraft:ghast_tear', ['ghast_tear', 'enchanted_ghast_tear']),
    ...
    'woods_fishes': ('&2Woods & Fishes', 'minecraft:fishing_rod', (3, 4), [
        ...
        ('fish', 'Fish', 'minecraft:cod',
         ['cod', 'salmon', 'tropical_fish', 'pufferfish', 'enchanted_raw_cod', 
          'enchanted_cooked_cod', 'enchanted_raw_salmon', 'enchanted_cooked_salmon', 
          'enchanted_clownfish', 'enchanted_pufferfish']),
        ('flowers', 'Flowers', 'minecraft:poppy',
         ['poppy', 'dandelion', 'enchanted_poppy', 'enchanted_dandelion', 
          'enchanted_azure_bluet', 'enchanted_lilac', 'enchanted_rose_bush', 
          'enchanted_large_fern', 'enchanted_dead_bush']),
        ('prismarine', 'Prismarine', 'minecraft:prismarine_shard',
         ['prismarine_shard', 'prismarine_crystals', 'enchanted_prismarine_shard', 
          'enchanted_prismarine_crystals', 'enchanted_dark_prismarine']),
        ('clay', 'Clay', 'minecraft:clay_ball', ['clay_ball', 'enchanted_clay_ball']),
        ('sponge', 'Sponge', 'minecraft:sponge', ['sponge', 'enchanted_sponge']),
        ('lily_pad', 'Lily Pad', 'minecraft:lily_pad', ['lily_pad', 'enchanted_lily_pad']),
        ('ink_sac', 'Ink Sac', 'minecraft:ink_sac', ['ink_sac', 'enchanted_ink_sac', 'enchanted_lime_dye']),
